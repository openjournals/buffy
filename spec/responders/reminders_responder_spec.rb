...
describe RemindersResponder do
  ...
  describe "#process_message" do
    ...
    it "should respond an error message if user is not an author or reviewer" do
  ...
  describe "configurable targets" do
    ...
    it "targets has default values" do
      @responder.params = {}
      expect(@responder.targets).to eq(["@author", "@reviewer33", "@reviewer42"])
    end
    ...
    it "targets are uniq" do
      ...
      expect(@responder.targets).to eq(["@author1", "@author2", "@extra-reviewer", "@reviewer33", "@reviewer42"])
    end
  end
end